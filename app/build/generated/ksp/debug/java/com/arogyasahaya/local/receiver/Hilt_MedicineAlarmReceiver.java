...
public abstract class Hilt_MedicineAlarmReceiver extends BroadcastReceiver {
  ...
  protected void inject(Context context) {
    if (!injected) {
      synchronized (injectedLock) {
        if (!injected) {
          ((MedicineAlarmReceiver_GeneratedInjector) BroadcastReceiverComponentManager.generatedComponent(context)).injectMedicineAlarmReceiver(UnsafeCasts.<MedicineAlarmReceiver>unsafeCast(this));
          injected = true;
        }
      }
    }
